...
export const UnitPlainInputCreate = t.Object(
  {
    ...
    amountGenerate: t.Optional(t.Number()),
    documents: t.Array(t.String(), { additionalProperties: false }),
  ...
  t.Object(
    {
      ...
      livingroom: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
      ...
      amountGenerate: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
