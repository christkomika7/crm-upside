...
import { MODULE_ROUTES } from "@/components/not-found";
import { canAccess } from "@/lib/permission";
import { moduleFr, modules } from "@/lib/zod/permissions";
...
export const Route = createRootRouteWithContext<RouterContext>()({
	...
	notFoundComponent: async () => {
		...
		const permission = (resolvedSession?.data?.user as unknown as User)?.permission?.permissions;
		...
		return <div className="min-h-screen bg-neutral-50 flex flex-col items-center justify-center p-6">
