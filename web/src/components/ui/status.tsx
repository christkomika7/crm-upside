  ...
  "inline-flex w-fit shrink-0 items-center gap-1.5 overflow-hidden whitespace-nowrap rounded-full border px-2.5 py-1 font-medium text-xs transition-colors",
  {
    variants: {
      variant: {
        ...
        emerald:
          "border-transparent rounded-sm bg-emerald-50 text-emerald-600",
        amber:
          "border-transparent rounded-sm bg-amber-400/10 text-amber-500",
        cyan:
          "border-transparent rounded-sm bg-cyan-50 text-cyan-600",
        indigo:
          "border-transparent rounded-sm bg-indigo-700/5 text-indigo-600",
      },
    },
    defaultVariants: {
      variant: "default",
