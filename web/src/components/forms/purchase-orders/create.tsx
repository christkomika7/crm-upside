...
export default function CreatePurchaseOrder() {
    ...
    const mutation = useMutation({
        mutationFn: (data: PurchaseOrderSchemaType) =>
            crudService.post<PurchaseOrderSchemaType, any>("/purchase-order/", data),
        onSuccess() {
    ...
    return (
        <div className="bg-white rounded-md space-y-4 p-4">
            <h2 className="font-medium">Informations sur le bon de commande</h2>
            <Form {...form}>
