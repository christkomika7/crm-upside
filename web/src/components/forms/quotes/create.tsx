...
export default function Create() {
    ...
    const mutation = useMutation({
        mutationFn: (data: QuoteSchemaType) =>
            crudService.post<QuoteSchemaType, any>("/quote/", data),
        onSuccess() {
    ...
    return (
        <div className="bg-white rounded-md space-y-4 p-4">
            <h2 className="font-medium">Informations du devis</h2>
            <Form {...form}>
                <form onSubmit={form.handleSubmit(submit)} className="space-y-4.5 w-full">
