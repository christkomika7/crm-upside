import EditPurchaseOrder from "@/components/forms/purchase-orders/edit";
import Preview from "@/components/forms/purchase-orders/preview";
import Share from "@/components/forms/purchase-orders/share";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { useSearch } from "@tanstack/react-router";

export default function PurchaseOrderTabs({ id }: { id: string }) {
    const search = useSearch({ from: "/dashboard/purchase-orders/edit-purchase-order/$id" });
